...
\chapter{Senior First Semester}
\input{./2_task_description.tex}
\input{./3_collaboration_techonolies.tex}
\input{./4_evaluation_of_hadoop_distros.tex}
\input{./5_data_profiling.tex}
\input{./6_nominatim.tex}
\input{./7_database.tex}
\input{./8_graphhopper.tex}
\input{./9_django.tex}
\input{./10_responsabilities.tex}
\input{./11_conclusion_and_outlook.tex}
\chapter{Senior Second Semester}
\input{./12_task_description_2.tex}
\input{./13_2_digits_db.tex}
\input{./14_django_2.tex}
\input{./15_data_prediction.tex}
\input{./17_conclusion_2.tex}
\chapter{Junior Team}
\input{./21_junior_task_description.tex}
\input{./29_junior_conclusion.tex}
\section{Outlook}
